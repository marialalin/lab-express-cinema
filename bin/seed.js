require("../config/db.config") // requerimos la configuración de la base de datos
const Movie = require("../models/Movie.model") //requerimos el modelo de Movie que hemos creado
...
const movies = [
  ...
  Movie.create(movies)
    .then(() => console.log(`movies created`))
    .catch((err) => console.log(`error creating movies`))